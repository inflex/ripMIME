...
char version[] = "v1.4.1.0 - September 20, 2022 (C) PLDaniels http://www.pldaniels.com/ripmime";
char help[] = "ripMIME -i <mime file> -d <directory>"
   ...
   "--randprefix : rename by putting unique code and random number at the front of the filename\n"
   "--randpostfix : rename by putting unique code and random number at the end of the filename\n"
   "--randinfix : rename by putting unique code and random number in the middle of the filename\n"
   "\n"
           ...
           switch (argv[i][1])
           {
               ...
               case '-':
                    ...
                    ** detects a MIME encoded email **/
                       ...
                       {
                           MIME_set_renamemethod (_MIME_RENAME_METHOD_RANDPREFIX);
                       }
                       ...
                       {
                           MIME_set_renamemethod (_MIME_RENAME_METHOD_RANDINFIX);
                       }
